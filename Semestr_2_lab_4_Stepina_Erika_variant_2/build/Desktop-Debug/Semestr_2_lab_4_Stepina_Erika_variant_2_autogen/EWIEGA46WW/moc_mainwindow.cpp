...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "MainWindow",
        "0$bg+OkjlYxu16NgF8jXcbusExGpY",
        "on_addKm_clicked",
        "",
        "on_showGovNum_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_addKm_clicked'
        QtMocHelpers::SlotData<void()>(2, 3, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_showGovNum_clicked'
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_addKm_clicked(); break;
        case 1: _t->on_showGovNum_clicked(); break;
        default: ;
        }
    }
    (void)_a;
